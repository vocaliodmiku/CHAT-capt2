...
class MOSS002ENHarmlessnessPrompt(RawDataset):
    NAME: str = 'moss-002-prompt_en_harmlessness'
    PATH: list[str] = [
        '/ssd9/exec/shenchengen/data/models/llm_data/Alpaca-CoT/MOSS/moss-002-sft/en_harmlessness_context.json',
        # '/ssd9/exec/shenchengen/data/models/llm_data/Alpaca-CoT/MOSS/moss-002-sft/en_harmlessness.json'
    ]
    ...
    def __getitem__(self, index: int) -> RawSample:
        ...
        answer = item['output']
        if '[HM]:' in prompt:
            prompt = str(prompt).replace("[HM]:", "Human:").replace("[AI]:", "\nAssistant:") + "\n\nAssistant: "
        else:
            prompt = "Human: " + prompt + "\n\nAssistant: "


        return RawSample(input=prompt, answer=answer)

    def __len__(self) -> int:
        return len(self.data)


class MOSS002ENHonestyPrompt(RawDataset):
    NAME: str = 'moss-002-prompt_en_honesty'
    PATH: list[str] = [
        '/ssd9/exec/shenchengen/data/models/llm_data/Alpaca-CoT/MOSS/moss-002-sft/en_honesty_context.json',
        # '/ssd9/exec/shenchengen/data/models/llm_data/Alpaca-CoT/MOSS/moss-002-sft/en_honesty.json'
    ]
...
class MOSS002ENHelpfulnessPrompt(RawDataset):
    NAME: str = 'moss-002-prompt_en_helpfulnessy'
    PATH: list[str] = [
        '/ssd9/exec/shenchengen/data/models/llm_data/Alpaca-CoT/MOSS/moss-002-sft/en_helpfulness_context.json',
        # '/ssd9/exec/shenchengen/data/models/llm_data/Alpaca-CoT/MOSS/moss-002-sft/en_helpfulness.json'
    ]
...
class MOSS002ZHHelpfulnessPrompt(RawDataset):
    NAME: str = 'moss-002-prompt_zh_helpfulnessy'
    PATH: list[str] = [
        '/ssd9/exec/shenchengen/data/models/llm_data/Alpaca-CoT/MOSS/moss-002-sft/zh_helpfulness_context.json',
        # '/ssd9/exec/shenchengen/data/models/llm_data/Alpaca-CoT/MOSS/moss-002-sft/zh_helpfulness.json'
    ]
...
class MOSS002ZHHonestynessPrompt(RawDataset):
    NAME: str = 'moss-002-prompt_zh_honesty'
    PATH: list[str] = [
        '/ssd9/exec/shenchengen/data/models/llm_data/Alpaca-CoT/MOSS/moss-002-sft/zh_honesty_context.json',
        # '/ssd9/exec/shenchengen/data/models/llm_data/Alpaca-CoT/MOSS/moss-002-sft/zh_honesty.json'
    ]
